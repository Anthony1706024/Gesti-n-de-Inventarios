...
<body>
    <div class="container py-5">
        <h2 class="font-semibold text-xl text-center">Insumos</h2>
        <div class="card overflow-hidden shadow-sm sm:rounded-lg mt-4">
            <div class="card-body text-gray-900">
                <h3 class="text-lg font-semibold mt-4">Lista de Insumos</h3>
                ...
                <table class="table table-striped mt-4">
                    ...
                    <tbody>
                        ...
                        <!-- Puedes agregar más insumos aquí -->
                    </tbody>
                </table>
            </div>
        </div>
